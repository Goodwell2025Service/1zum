...
def get_secret(setting, default=None):
    ...
    try:
        ...
        error_msg = f'Set the {setting} environ'
...
DEBUG = get_secret("DJANGO_DEBUG", False)
...
LOCAL_APPS = [
    ...
    "birzum.apps.smallapps.rating.apps.RatingConfig"
...
MIGRATION_MODULES = {"sites": "birzum.contrib.sites.migrations"}
...
ADMINS = [("""Ubaydullo Ibrohimov""", 'ubuhobbit@gmail.com')]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "birzum.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "birzum.users.adapters.SocialAccountAdapter"
